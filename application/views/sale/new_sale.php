        ...
        <section class="content">
          ...
          <div class="box">
            <div class="box-header with-border">
              <div class="row">
                  <div class="col-md-2">
                   <button class="btn btn-block btn-success" id="txtInvoicePrint" name="txtInvoicePrint">Print</button>
                   </div>
                   <div class="col-md-2">
                   <button class="btn btn-block btn-primary" id="txtInvoiceSave" name="txtInvoiceSave">Save</button>
                   </div>
                  </div>
